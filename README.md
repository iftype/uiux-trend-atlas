...
매주 GitHub Actions가 공식 RSS/Atom 피드를 확인해 최신 해외 UI/UX 글 목록과 피드 상태를 갱신합니다. 변경된 데이터는 자동 커밋되고 GitHub Pages가 다시 배포됩니다. Actions의 **Refresh foreign UI UX research** 워크플로는 필요할 때 수동 실행할 수도 있습니다.
